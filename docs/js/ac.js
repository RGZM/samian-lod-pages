let ac = (termObject) => {
  // object
  searchResultsDiv +=
    "<div class='box-resultlist-eighty' id='" +
    termObject["item"]["value"] +
    "'>";
  searchResultsDiv +=
    "<h1 style='text-align:center;padding-bottom:10px;'>Actor as a Concept: " +
  ...
  objectdataDetailsDiv +=
    '<br><h3><center><img src="al_circle_icon.png" height="80"></center></h3>';
  ...
  let funding =
    "RGZM, University of Reading, University of Leeds, Ceramica-Stiftung";
  let contact =
    "Department of Scientific IT, RGZM, Mainz (Dr. Allard Mees, Florian Thiery M.Sc.)";
  let date = "since 1963";
  objectdataDetailsDiv +=
    "<ul class='list-group panel-item2' id='" +
    "project-1" +
  ...
  if (termObject["name"]["value"] == "undefined") {
