...
let openDetailFeature = (obj, feature) => {
    console.log('object.htm?id=' + obj + "&feature=" + feature);
    window.open('object.htm?id=' + obj + "&feature=" + feature, '_blank');
}

let openDetailComp = (id) => {
    window.open('comparisonviewer/index.htm?comparison_id=' + id.replace("ars3d:", ""), '_blank');
}
